...
class PublicData:
    ...
    def get_indexes_of_features_to_vary(self, features_to_vary='all', permitted_option='all'):
        ...
        if features_to_vary == "all":
            ...
            if permitted_option == "all":
                ...
                permitted_cat_features = []
                for key in permitted_option:
                    options = permitted_option[key]
                    for value in options:
                        permitted_cat_features.append(key + "_" + value)
                for colidx, col in enumerate(self.encoded_feature_names):
                    if colidx in encoded_cats_ixs and col.startswith(tuple(features_to_vary)) and col in permitted_cat_features:
                        ixs.append(colidx)
                    elif colidx not in encoded_cats_ixs and col in features_to_vary:
                        ixs.append(colidx)
            return ixs
